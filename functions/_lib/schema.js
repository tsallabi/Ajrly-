...
export const SCHEMA_STATEMENTS = [
  ...
  // cities distribution buckets (dashboard pie chart)
  "CREATE TABLE IF NOT EXISTS city_targets (id TEXT PRIMARY KEY, city TEXT, count TEXT, color TEXT, created_at TEXT NOT NULL DEFAULT (datetime('now')), updated_at TEXT NOT NULL DEFAULT (datetime('now')))",
...
export const SCHEMA_ALTERS = [
  ...
  // budgets — description added later
  "ALTER TABLE budgets ADD COLUMN description TEXT",
  // city_targets — repurposed for the dashboard cities pie (count + colour)
  "ALTER TABLE city_targets ADD COLUMN count TEXT",
  "ALTER TABLE city_targets ADD COLUMN color TEXT",
];
