...
registerStrings({
  ar: {
    ...
    "intg.import.sub": "ملف CSV، أو لصق جدول، أو جلب من app.ajr.ly",
    ...
    "intg.import.fetch": "جلب من app.ajr.ly",
  ...
  en: {
    ...
    "intg.import.sub": "CSV file, paste a table, or fetch from app.ajr.ly",
    ...
    "intg.import.fetch": "Fetch from app.ajr.ly",
